    ...
    <div class="row">
         ...
         <div class="col-lg-3">
          ...
          <label for="teacher" >Teacher Name</label>
           ...
           <option >Sir Teslin</option>
           <option >Sir Brijesh</option>
           <option >Miss Shweta </option>
           <option >Miss Kavita </option>
           <option >Miss Minaz</option>
           <option >Miss Akshara</option>
           <option >Sir Nagaraj</option>
           </select>
          </div>
          </div>
      </div>
